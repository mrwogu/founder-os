...
defines portable instructions and runtime declarations; `.promptscript/agents.prs`
defines roles; and `.promptscript/skills/` is auto-discovered so every workflow
